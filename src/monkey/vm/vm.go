...
const GlobalsSize = 65536 // 16 bits
...
type VM struct {
	...
	stack []object.Object
	sp    int // 'stack-pointer' always point to the next value. Top of stack is stack[sp-1]
...
func (vm *VM) executeCall(numArgs int) error {
	...
	default:
		return fmt.Errorf("calling non-funtion and non-builtin")
	}
}
...
// assert types of operands and execute operation.
