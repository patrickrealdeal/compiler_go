...
func TestCompilerScopes(t *testing.T) {
	...
	if compiler.symbolTable != globalSymbolTable {
		t.Errorf("compiler di not restore global symbol table")
	}
...
func runCompilerTests(t *testing.T, tests []compilerTestCase) {
	...
	for _, tt := range tests {
		...
		err = testIntructions(tt.expectedInstructions, bytecode.Instructions)
		if err != nil {
		...
		if err != nil {
			t.Fatalf("testConstants failse: %s", err)
		}
	}
}
...
func testIntructions(expected []code.Instructions, actual code.Instructions) error {
...
func testConstants(t *testing.T, expected []interface{}, actual []object.Object) error {
	...
	for i, constant := range expected {
		...
		case []code.Instructions:
			...
			err := testIntructions(constant, fn.Instructions)
			if err != nil {
